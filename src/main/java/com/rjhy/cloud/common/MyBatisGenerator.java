    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root123")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/rjhy?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.rjhy.cloud."+packageName)// 自定义包路径.
                        .setController("controller")// 这里是控制器包名，默�? web
                        .setEntity("entity")
                        .setMapper("dao")
                        //.setService("service")
                ...
                new InjectionConfig() {
                    ...
                    public void initMap() {
                		...
                		//templates 用于无BaseController版本， templatesWithBaseClass 用于有BaseController版本
